                ...
                get(target, p, receiver) {
                    return function () {
                        return __awaiter(this, arguments, void 0, function* () {
                            ...
                            // 类注解
                            yield resolve(undefined, getNetHubInterpreter(constructor.prototype));
                            // 方法注解
                            yield resolve("NetHub: 方法 缺少注解 @Method/@GET/@POST...", getNetHubInterpreter(constructor.prototype, p.toString()));
                            // 参数注解
                            if (args.length) {
