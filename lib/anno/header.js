        ...
        return function (value) {
            ...
            return function (target, propertyKey, parameterIndex) {
                if (typeof parameterIndex === "number") {
                    return addNetHubInterpreter(that.collectFieldWithValue(value), target, propertyKey, String(parameterIndex));
                }
                return addNetHubInterpreter(that.collectMethodWithValue(value), target, propertyKey);
            };
        };
    }
}
